    ...
    <div>
        ...
        <div class="col-12">
            <form novalidate @submit.prevent="addSession">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <small id="sequenceHelpId" class="text-muted"
                            >Sequence ID is the serial number of the session in
                            the workshop</small
                        >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <small id="speakerHelpId" class="text-muted"
                            >The name of the speaker(s) for this session.
                            Separate speaker names by a comma. Example
                ...
                <div class="form-group row">
                    <label htmlFor="level" class="col-sm-3 col-form-label"
                        >Level</label
                    >
                    <div class="col-sm-9">
                        <select class="form-control" name="level" id="level">
                            <option value="">
                                -- Select the level of the session --
                            </option>
...
<script>
    // EXERCISE: Do validations using Vuelidate
